...
void GUI::drawRectangle(int left, int top, int width, int height)
{
	gotoXY(left, top);
	std::cout << char(201);
...
void GUI::hideCursor(bool isHiden)
{
...
std::string GUI::getTextElementBox(std::string text)
{
	std::string roomName;
	system("cls");
	setColor(7);
...
int GUI::centerWindow(int width)
{
...
int GUI::centerBox(int boxWidth, int width)
{
	int terminalWidth = (getTerminalWidth() / 2);
...
void GUI::loadingEffect(std::string text)
{
	system("cls");
	int width = 46;
	int height = 5;
...
void GUI::notiBox(std::string text)
{
	system("cls");
	setColor(7);
	hideCursor(true);
...
int GUI::optionMenu(int height, std::string chatLabel, std::string menuLabel, int numberMenu, ...)
{
	system("cls");
	hideCursor(true);
...
void GUI::clearBuffer(int length)
{
	std::cout << "\r";
...
void GUI::removeRectangle(int left, int top, int width, int height)
{
	hideCursor(true);
	gotoXY(left, top);
	std::cout << " ";
